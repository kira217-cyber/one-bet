...
const getWithdrawSearchText = (item) => {
  return (
...
const WithdrawHistory = () => {
  ...
  const { data, isLoading, isFetching, refetch } = useQuery({
    queryKey: ["withdraw-history", queryParams],
    queryFn: async () => {
      const res = await api.get(`/api/history/me/withdraws?${queryParams}`);
      return res.data;
    },
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[12px] text-white/60">
                View all your withdraw transactions
              </p>
            </div>
          </div>
              ...
              <div className="flex items-center gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    placeholder="Search transaction / wallet / note..."
