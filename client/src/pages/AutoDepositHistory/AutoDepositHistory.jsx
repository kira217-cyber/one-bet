...
const openFootprint = (url) => {
  if (!url) {
    toast.error("Footprint link not found");
    return;
  }
      ...
      <div className="grid grid-cols-1 gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-[12px] text-white/60">
                View all your auto deposit transactions
              </p>
            </div>
          </div>
          ...
          <div className="mt-5 grid grid-cols-1 gap-3">
            ...
            <div>
              ...
              >
                ...
                <option value="PAID" className="bg-[#0a0a0a]">
                  Paid
                </option>
                <option value="FAILED" className="bg-[#0a0a0a]">
                  Failed
                </option>
              </select>
            </div>
              ...
              <div className="flex items-center gap-2">
                <div className="relative flex-1">
                  ...
                  <input
                    ...
                    placeholder="Search invoice / transaction / bank..."
        ...
        <div className="overflow-hidden border border-green-700/40 bg-gradient-to-br from-black via-green-950/20 to-black shadow-lg shadow-green-900/20">
          <div className="overflow-x-scroll">
            <table className="w-full min-w-[1320px] whitespace-nowrap">
              <thead>
                      ...
                      <td className="px-4 py-4">
                        {item.footprint ? (
                          <button
                            ...
                            className="inline-flex h-9 w-9 items-center justify-center rounded-xl border border-sky-500/30 bg-sky-500/10 text-sky-300 transition hover:bg-sky-500/20"
