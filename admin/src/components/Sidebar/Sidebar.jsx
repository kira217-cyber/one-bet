  ...
  const affiliateItems = useMemo(
    () => [
      ...
      },
      {
        ...
        to: "/aff-hero-controller",
        icon: <FaImage />,
        text: "Affiliate Hero Controller",
      },
      {
        key: "aff-campaigns-controller",
        to: "/aff-campaigns-controller",
        icon: <FaImage />,
        text: "Affiliate Campaigns Controller",
      },
      {
        key: "aff-faq-controller",
        to: "/aff-faq-controller",
        icon: <FaQuestionCircle />,
        text: "Affiliate FAQ Controller",
      },
      {
        key: "aff-commission-controller",
        to: "/aff-commission-controller",
        icon: <FaPlay />,
        text: "Affiliate Commission Controller",
      },
      {
        key: "aff-commission-structure-controller",
        to: "/aff-commission-structure-controller",
        icon: <FaTable />,
        text: "Affiliate Commission Structure",
      },
      {
        key: "aff-jackpot-controller",
        to: "/aff-jackpot-controller",
        icon: <FaImage />,
        text: "Affiliate Jackpot Controller",
      },
      {
        key: "aff-jackpot-structure-controller",
        to: "/aff-jackpot-structure-controller",
        icon: <FaTable />,
        text: "Affiliate Jackpot Structure",
      },
      {
        key: "aff-elite-club-controller",
        to: "/aff-elite-club-controller",
        icon: <FaCrown />,
        text: "Affiliate Elite Club",
      },
      {
        key: "aff-how-to-join-controller",
        to: "/aff-how-to-join-controller",
        icon: <FaListOl />,
        text: "Affiliate How To Join",
      },
      {
        key: "aff-about-us-controller",
        to: "/aff-about-us-controller",
        icon: <FaInfoCircle />,
        text: "Affiliate About Us",
      },
      {
        key: "aff-why-us-controller",
        to: "/aff-why-us-controller",
