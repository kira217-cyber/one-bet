...
const AffSiteIdentityController = () => {
  ...
  const fetchAffSiteIdentity = async () => {
    try {
      setLoading(true);
      const res = await api.get("/api/admin/aff-site-identity");
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const res = await api.post("/api/admin/aff-site-identity", payload, {
        headers: {
  ...
  const handleDeleteLogo = async () => {
    ...
    try {
      const res = await api.delete("/api/admin/aff-site-identity/logo");
      toast.success(
  ...
  const handleDeleteFavicon = async () => {
    ...
    try {
      const res = await api.delete("/api/admin/aff-site-identity/favicon");
      toast.success(
      ...
      <div className="mx-auto w-full max-w-7xl">
        ...
        <div className="grid grid-cols-1 gap-6">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <p className="text-sm text-green-200/80">
                    Upload logo, favicon and affiliate titles.
                  </p>
                </div>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5 p-5">
              <div className="space-y-2">
                ...
                <input
                  ...
                  placeholder="অ্যাফিলিয়েট ওয়েবসাইটের বাংলা টাইটেল লিখুন"
          ...
          >
            <div className="border-b border-green-600/20 bg-gradient-to-r from-green-600/20 to-emerald-500/10 px-5 py-4">
              <h2 className="text-lg font-bold text-white md:text-xl">
                Current Affiliate Site Identity
              </h2>
              <p className="mt-1 text-sm text-green-200/80">
                Currently saved affiliate website information.
              </p>
            </div>
